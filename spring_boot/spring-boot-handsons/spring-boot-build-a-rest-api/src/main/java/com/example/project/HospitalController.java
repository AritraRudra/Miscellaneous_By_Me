...
public class HospitalController {
	...
	@RequestMapping(path = "/hospitals/{id}",method = RequestMethod.GET)
	...
	@RequestMapping(path = "/hospitals/",method = RequestMethod.PUT)
	public ResponseEntity<String> updateHospital(@RequestBody Hospital hospital) {
		hospitalService.updateHospital(hospital);
		return new ResponseEntity<String>(HttpStatus.OK);
	}

	@RequestMapping(path = "/hospitals/",method = RequestMethod.DELETE)
