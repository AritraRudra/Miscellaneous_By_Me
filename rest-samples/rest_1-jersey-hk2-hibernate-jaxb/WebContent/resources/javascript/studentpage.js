...
function getStudentByID(student_id){
	...
	getStudentsFromServer(dataAsJson, url, "GET", responseAsJson);
}
...
function getStudentsFromServer(data, url, method, callback) {
...
function deleteStudentByID(student_id){
	//var url = "rest/student/" + encodeURIComponent(student_id);		// rest/student/5
	var url = "rest/student/" + student_id;		// rest/student/5
	console.log("URL ", url);
	// alert("URL ", url);
	// callback https://www.w3schools.com/js/js_ajax_http_response.asp
	deleteStudentByIDFromServer("", url, "DELETE", callbackDeleteStudent);
	//var res = callback something ??
	//return res;
}

function callbackDeleteStudent(){
	var resp  = JSON.parse(this.responseText);
	console.log("In callbackDeleteStudent", resp);
	if(resp){
		alert("In callbackDeleteStudent"+ resp);
	}
}

function deleteStudentByIDFromServer(data, url, method, callback) {
	console.log("In deleteStudentByIDFromServer");
	console.log(data);
	console.log(url);
	// construct an HTTP request
	var xhr = new XMLHttpRequest();
...
function deleteStudentByIDAsJSON(student_id){
	//getStudentByID(student_id, "rest/student/", "GET");
	var studentidParam = "studentid"
	data = {studentidParam:student_id};
	dataAsJson = JSON.stringify(student_id);
	...
	// alert("URL ", url);
	// callback https://www.w3schools.com/js/js_ajax_http_response.asp
	var res = deleteStudentByIDAsJSONFromServer(dataAsJson, url, "DELETE", responseAsJson);
	return res;
}

function deleteStudentByIDAsJSONFromServer(data, url, method, callback) {
	console.log("In deleteStudentByIDFromServer");
	console.log(data);
	console.log(url);
	// construct an HTTP request
