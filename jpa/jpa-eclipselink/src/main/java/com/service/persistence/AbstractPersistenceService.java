...
import com.managers.PersistenceManagerFor_EclipseLink_JPA;

public abstract class AbstractPersistenceService implements PersistenceService{
	private static final EntityManager entityManager = PersistenceManagerFor_EclipseLink_JPA.INSTANCE.getEntityManager();
	...
	protected static void close(){
		PersistenceManagerFor_EclipseLink_JPA.INSTANCE.close();
	}
