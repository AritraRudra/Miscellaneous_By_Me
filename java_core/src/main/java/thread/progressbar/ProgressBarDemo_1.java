...
public class ProgressBarDemo_1 {
	...
	public static void main(String[] args) {
		...
		*/
		ProgressBarRotating_1_1 runnableDemo = new ProgressBarRotating_1_1();
...
class ProgressBarRotating_1_1 implements Runnable {
	...
	public ProgressBarRotating_1_1() {
		super();
	}

	public ProgressBarRotating_1_1(String threadName) {
		super();
